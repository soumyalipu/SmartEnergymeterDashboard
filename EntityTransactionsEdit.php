...
<html lang="en">
<head>
  <?php headContent("EntityTransactionsEdit");?>
</head>
...
<div class="container">
	<h3 class="w3-padding w3-card-2 w3-green">Edit Transactions</h3>
	<div class="w3-card-2 w3-padding " style="margin-top:-12px;overflow-x:scroll" >
		<form method="POST" enctype="multipart/form-data" >
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter id ..." class="w3-input form-control" name="id" id="id"  value="<?php echo $transactions->id; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter machine_id ..." class="w3-input form-control" name="machine_id" id="machine_id"  value="<?php echo $transactions->machine_id; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter bill_amount ..." class="w3-input form-control" name="bill_amount" id="bill_amount"  value="<?php echo $transactions->bill_amount; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="number" placeholder="Please enter curr_balance ..." class="w3-input form-control" name="curr_balance" id="curr_balance"  value="<?php echo $transactions->curr_balance; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter volt ..." class="w3-input form-control" name="volt" id="volt"  value="<?php echo $transactions->volt; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter current ..." class="w3-input form-control" name="current" id="current"  value="<?php echo $transactions->current; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter power ..." class="w3-input form-control" name="power" id="power"  value="<?php echo $transactions->power; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="date" placeholder="Please enter date ..." class="w3-input form-control" name="date" id="date"  value="<?php echo $transactions->date; ?>" />
			</div>
			...
			<div class="form-group col-md-12">
				...
				<input type="text" placeholder="Please enter time ..." class="w3-input form-control" name="time" id="time"  value="<?php echo $transactions->time; ?>" />
			</div>
...
<?php
	if(isset($_POST["submitForm"]))
	{
		...
		if($transactionsModel -> UpdateTransactions($transactions))
		{
			 echo '<script>alert("Transactions updated successfully...");window.location=window.location.href;</script>';
		}
		else
		{
			 echo '<script>alert("Unable to updated Transactions ...");window.location=window.location.href;</script>';
		}
	}
?>
<!-- End: Edit Form PHP-->
