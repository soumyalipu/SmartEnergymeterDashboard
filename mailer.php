...
$u_email=$_GET['email'];
$link="http://demo.techforfun.in//vmail.php?email=".$u_email;
$html="<html>
<head>
    <title></title>
    <style type='text/css'>
                ...
                <table border='0' cellpadding='0' cellspacing='0' width='100%' style='max-width: 600px;'>
                    ...
                    <tr>
                        <td bgcolor='#ffffff' align='left' style='padding: 0px 30px 40px 30px; border-radius: 0px 0px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;'>
                            <p style='margin: 0;'>Cheers,<br>Sky Genesis</p>
                        </td>
                    </tr>
                </table>
            </td>
...
echo smtp_mailer($u_email,'Verify Your Email',$html);
function smtp_mailer($to,$subject, $msg){
	...
	$mail->SMTPAuth = true; 
	$mail->SMTPSecure = 'tls'; 
	$mail->Host = "mail.techforfun.in";
	$mail->Port = 587; 
	$mail->IsHTML(true);
	$mail->CharSet = 'UTF-8';
	$mail->Username = "soumya@techforfun.in";
	$mail->Password = "Soumya@1234";
	$mail->SetFrom("soumya@techforfun.in");
	...
	if(!$mail->Send()){
		echo $mail->ErrorInfo;
		 ...
		 echo '<script>alert("verify your emailid");window.location="login.php";</script>';
	}
}
?>